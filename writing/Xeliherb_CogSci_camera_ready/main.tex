...
\item \textbf{Neutral}\footnote{We treat conditionals as semantically non-causal; causal readings, where they arise, are pragmatic enrichments \citep[cf.][]{grusdt_probabilistic_2022}.}: ``If ralocrop grows, then xeliherb grows too.''
...
This research is part of the ``Communicating Causality'' project, supported by the UK Arts and Humanities Research Council (grant number AH/Z507490/1, PI: Daniel Lassiter); and the Deutsche Forschungsgemeinschaft (PI: Michael Franke) under project ID 547376651. 
The work of Hening Wang and Michael Franke for this project was supported by the project LMBayes (grant: Leibniz Collaborative Excellence 22-20, PI Anton Benz).
